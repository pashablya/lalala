...
public class StudentAdapter extends BaseAdapter {
    ...
    public StudentAdapter(Context context, List<Student> students, WindowManager windowManager){
    ...
    private void initTextViewSizes(View view){
         ...
         view.findViewById(R.id.student_name).setLayoutParams(new LinearLayout.LayoutParams((int) (width * 0.27), 200));
         view.findViewById(R.id.parent_name).setLayoutParams(new LinearLayout.LayoutParams((int)(width*0.27),200));
         view.findViewById(R.id.job).setLayoutParams(new LinearLayout.LayoutParams((int)(width*0.17),200));
         view.findViewById(R.id.position).setLayoutParams(new LinearLayout.LayoutParams((int)(width*0.18),200));
         view.findViewById(R.id.experience).setLayoutParams(new LinearLayout.LayoutParams((int)(width*0.11),200));
    }
